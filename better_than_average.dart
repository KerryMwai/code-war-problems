bool betterThanAverage(List<int> classpoints,int youpoints ) {
    
    return (classpoints.fold(0, (previousValue, element) => previousValue+element)/classpoints.length)>youpoints?false:true;
} 

void main(){
  print(betterThanAverage([100, 40, 34, 57, 29, 72, 57, 88], 78));
}
